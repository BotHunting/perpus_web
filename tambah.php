	...
	<div class="container col-8 mb-5" style="margin-top:20px">
		...
		<div class="card card-danger text-dark">
			<div class="card-header border-0">
              ...
              <form role="form" action="tambah.php" method="POST" class="mb-5">
                <div class="card-body text-dark">
				  ...
				  <div class="form-group">
					...
					<select class="form-control" name="id_petugas">
						...
						<?php
						// Perintah sql untuk menampilkan semua data pada tabel petugas
						$sql = "SELECT id_petugas, nama_petugas FROM petugas ORDER BY id_petugas ASC";
						...
						while ($data = mysqli_fetch_array($hasil)) {
							...
							if (isset($_GET['id_petugas'])) {
								$petugas = trim($_GET['id_petugas']);
								if ($petugas == $data['id_petugas']) {
									$ket = "selected";
								}
							}
						?>
							<option <?php echo $ket; ?> value="<?php echo $data['id_petugas']; ?>"><?php echo $data['id_petugas'] . ' - ' . $data['nama_petugas']; ?></option>
						<?php
						}
						?>
					</select>
                ...
                <input name="btnsubmit" type="submit" class="btn btn-primary" style="margin-left: 20px"></button><button type="reset" class="btn btn-danger" style="margin-left: 20px">Batal</button>
              </form>
            </div>
	</div>
