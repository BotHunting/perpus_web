...
<body>
    ...
    <div class="container" style="margin-top:20px">
        ...
        if(isset($_POST['submit'])){
            ...
            $sql = mysqli_query($coneksi, "UPDATE buku SET judul_buku='$judul_buku', penulis='$penulis', edisi='$edisi', impersum='$impersum', lokasi='$lokasi', isbn='$isbn', golongan='$golongan', bahasa='$bahasa' WHERE id_buku='$id_buku'") or die(mysqli_error($coneksi));
            
            if($sql){
                echo '<script>alert("Berhasil menyimpan data."); document.location="buku.php";</script>';
            }else{
